...
export default function Game() {
  ...
  return (
    <div className="min-h-screen pt-20 pb-24 px-4">
      ...
      >
        <h1 className="text-4xl font-bold text-red-600 text-center mb-6">Little memory challenge…though my favourite memory is youuu!😉</h1>
        <p className="text-center text-gray-700 mb-8">
          Match the 2 love symbols at a same time! Score: {score}/{emojis.length}
        </p>
