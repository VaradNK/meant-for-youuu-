...
const photos = [
  ...
  {
    url: img2,
    caption: "Those Late nights Texts"
  },
  {
    url: img3,
    caption: "Hope"
  ...
  {
    url: gallery1,
    caption: "The beauty I admire!🧿"
  },
  {
    url: gallery2,
    caption: "Okay...I don’t stare!🫣"
  },
  {
    url: gallery3,
    caption: "That innocence!🧀"
  }
];
    ...
    <div className="min-h-screen pt-20 pb-24 px-4 bg-transparent">
      ...
      >
        ...
        <p className="text-center text-gray-800 mb-12 max-w-3xl mx-auto">
          Every pic? Just another reason you stay on my mind!
        </p>
        ...
        >
          <p className="text-3xl font-bold text-purple-600">
            More laughs, more memories, more us — all the way into 2026!
          </p>
        </motion.div>
      </motion.div>
    </div>
